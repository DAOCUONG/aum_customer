...
class _$HomeInitialImpl extends HomeInitial {
  const _$HomeInitialImpl() : super._();
...
abstract class HomeInitial extends HomeState {
  const factory HomeInitial() = _$HomeInitialImpl;
  const HomeInitial._() : super._();
}
...
class _$HomeLoadedImpl extends HomeLoaded {
  ...
  @override
  String toString() {
    return 'HomeState.loaded(categories: $categories, recommendedFoods: $recommendedFoods, fastDeliveryRestaurants: $fastDeliveryRestaurants)';
  }
...
class _$HomeErrorImpl extends HomeError {
  const _$HomeErrorImpl({required this.message}) : super._();
